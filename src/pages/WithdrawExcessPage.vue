<template>
  ...
  <q-page v-if="bitkopaStore.connected && bitkopaStore.verified">
    ...
    <div class="gt-md q-pa-xs row justify-center">
      ...
      >
        <q-stepper v-model="step" ref="stepper" color="primary" animated>
          ...
          <q-step
            :name="2"
            title="Excess Collateral Amount"
            icon="payments"
            :done="step > 2"
            style="min-height: 200px"
          >
            <q-input
              outlined
              v-model="bitkopaStore.excessCollateralAmount"
              label-color="dark"
              label="Collateral Amount"
          ...
          <template v-slot:navigation>
            <q-stepper-navigation>
              <q-btn
                v-if="step === 3 && bitkopaStore.excessCollateralAmount > 0"
                @click="bitkopaStore.withdrawExcessCollateral"
                color="indigo"
                outline
                label="Submit"
              />
              <q-btn
                v-if="
                  step === 1 ||
                  (step === 2 && bitkopaStore.excessCollateralAmount > 0)
                "
          ...
          <template v-slot:message>
            ...
            >
              Excess Collateral:
              {{ bitkopaStore.selectedLoan.excessCollateral }}
              {{ bitkopaStore.selectedLoan.symbol }}
            </q-banner>
            <q-banner
              v-else-if="step === 3"
    ...
    <div class="lt-lg q-pa-xs row justify-center">
      <div
        v-if="bitkopaStore.loans.active.length"
        class="col-12 col-md-9 q-pt-md q-mt-xs q-px-md"
      >
        <q-stepper v-model="step" ref="stepper" color="primary" animated>
          <q-step
            :name="1"
